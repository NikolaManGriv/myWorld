...
- [ ] Create a basic streamlit app that takes a number and a string and prints something like "Hello \<name> your result is 2*\<number>"

- [ ] Create docker file for a very simple python program (add_app)
